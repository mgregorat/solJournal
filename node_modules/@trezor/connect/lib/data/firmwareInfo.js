...
const getReleaseInfo = (features) => (0, exports.getInfo)({
    features,
    releases: (0, exports.getReleases)(features?.internal_model),
});
exports.getReleaseInfo = getReleaseInfo;
const getRelease = (internalModel, firmwareVersion) => (0, exports.getReleases)(internalModel).find(r => firmwareVersion &&
