...
import { AccountController, ChainController, ConnectionController, ConnectorController, OptionsController, StorageUtil } from '../../exports/index.js';
import { AssetUtil } from '../../exports/utils.js';
import { useAppKitAccount, useAppKitConnection, useAppKitConnections, useDisconnect } from '../../exports/vue.js';
...
describe('useAppKitConnection', () => {
    ...
    beforeEach(() => {
        vi.resetAllMocks();
        vi.spyOn(ConnectionController.state, 'connections', 'get').mockReturnValue(new Map([['eip155', [mockConnection]]]));
    ...
    it('should handle switching connection successfully', async () => {
        ...
        const [state] = withSetup(() => useAppKitConnection({
            namespace: 'eip155',
    ...
    it('should use provided namespace instead of active chain', async () => {
        ...
        vi.spyOn(ConnectionController.state, 'connections', 'get').mockReturnValue(new Map([
            ['eip155', [mockConnection]],
    ...
    it('should handle case-insensitive connector matching', () => {
        ...
        const mockConnections = new Map([['eip155', [upperCaseConnection]]]);
        vi.spyOn(ChainController.state, 'activeChain', 'get').mockReturnValue('eip155');
        vi.spyOn(ConnectionController.state, 'connections', 'get').mockReturnValue(mockConnections);
        vi.spyOn(ConnectorController.state, 'activeConnectorIds', 'get').mockReturnValue({
            ...ConnectorController.state.activeConnectorIds,
