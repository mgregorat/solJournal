    ...
    createClients() {
        this.connectionControllerClient = {
            ...
            disconnect: async (params) => {
                ...
                const currentConnectorId = ConnectorController.getConnectorId(chainNamespace || ChainController.state.activeChain);
            ...
            this.chainNamespaces.forEach(namespace => {
                WcHelpersUtil.listenWcProvider({
                    ...
                    onChainChanged: chainId => {
                        ...
                        const isCurrentConnectorWalletConnect = ConnectorController.state.activeConnectorIds[activeNamespace] ===
